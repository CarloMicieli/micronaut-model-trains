...
class DeliveryDateTest {
    ...
    @Test
    void shouldParseDeliveryDateFromYearAndQuarter() {
    ...
    @Test
    void shouldProduceStringRepresentationsForDeliveryDates() {
    ...
    @Test
    void shouldThrowAnExceptionParsingInvalidDeliveryDates() {
