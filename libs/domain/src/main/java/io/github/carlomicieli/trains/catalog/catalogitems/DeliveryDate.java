...
public sealed interface DeliveryDate {
    ...
    //    default Year year() {
    //        return switch (this) {
    //            case ByMonth(YearMonth yearMonth) -> Year.of(yearMonth.getYear());
    //            case ByQuarter(Year year, ByQuarter.Quarter quarter) -> year;
    //            case ByYear(Year year) -> year;
    //        };
    //    }
    ...
    default Optional<Month> month() {
        ...
        // return switch (this) {
        //    case ByMonth(YearMonth yearMonth) -> Optional.of(yearMonth.getMonth());
